...
export const FEATURED_ACTORS: ActorProfile[] = [
  ...
  },
  {
    ...
    age: 23,
    location: 'Hyderabad',
    skills: ['Acting', 'Modern Dance', 'Modelling'],
    height: "5'5\"",
    languages: ['Telugu', 'Kannada', 'English'],
    profilePhoto: '/actors/4.jpg',
  },
  {
    id: 'fa3',
    name: 'Siddharth S.',
